          ...
          <div className="absolute top-6 right-6 z-30">
            <div className="relative">
              ...
              >
                {currentLang === 'EN' ? (
                  <svg
                    className="h-3.5 w-5 shrink-0 rounded-[1px] shadow-sm border border-slate-200"
                    viewBox="0 0 60 30"
                    width="18"
                    height="10"
                  >
                  ...
                  >
                    ...
                    <path
                      d="M30,10 L32.35,17.24 L39.9,17.24 L33.78,21.68 L36.13,28.92 L30,24.48 L23.87,28.92 L26.22,21.68 L20.1,17.24 L27.65,17.24 Z"
                      fill="#ffff00"
                    />
                  </svg>
                )}
              ...
              {isLangOpen && (
                <div className="absolute right-0 mt-1.5 w-32 rounded-xl border border-brand-border bg-white py-1 shadow-lg z-50 animate-in fade-in slide-in-from-top-1 duration-200">
                  ...
                  >
                    <svg
                      className="h-3 w-4.5 shrink-0 rounded-[1px] shadow-sm border border-slate-100"
                      viewBox="0 0 60 30"
                      width="14"
                      height="8"
                    >
